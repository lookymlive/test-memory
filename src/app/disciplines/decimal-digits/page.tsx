...
export default function DecimalDigitsPage() {
  const { user } = useAuth();
  ...
  const handleStart = () => {
    if (selectedDifficulty) {
      router.push(
        `/disciplines/decimal-digits/training?difficulty=${selectedDifficulty}`
      );
    }
  };
    ...
    <div className="container py-12">
      <div className="mb-8">
        ...
        <p className="text-lg mt-2 text-gray-600 dark:text-gray-300">
          Entrena tu memoria con secuencias de números decimales a diferentes
          velocidades.
        </p>
      </div>
      ...
      <div className="grid gap-6 mb-8">
        <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
          ...
          <ol className="space-y-2 list-decimal pl-5">
            <li>Se te mostrará una secuencia de dígitos, uno por uno.</li>
